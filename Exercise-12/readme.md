For a natural number `a` we say that it is a **poramnuvanje** of another natural number `b` **iff** the digits equal to `9` in `b` are replaced by `7` in `a`.
...
Your task is to print the smallest 5 poramnuvanja of all entered numbers, ordered from smallest to largest.
...
their poramnuvanja are: `7572, 67403, 100007, 6, 787, 6777` and `33437`, respectively,
